...
(function () {
  ...
  var RU = {
    ...
    name: 'Виктория',
    eyeRole: 'Медицинский косметолог',
    h1a: 'Уход за кожей',
    h1b: 'в светлом кабинете.',
    photoAlt: 'Медицинский косметолог Виктория в кабинете',
    sub: 'Виктория, медицинский косметолог. Запишитесь по телефону или напишите SMS.',
    call: 'Позвонить',
    ...
    contKicker: 'Контакты', contTitle: 'Контакты',
    ...
    title: 'Виктория, медицинский косметолог',
    desc: 'Медицинский косметолог Виктория. Запись по телефону +370 612 61703 или по SMS.'
  };
