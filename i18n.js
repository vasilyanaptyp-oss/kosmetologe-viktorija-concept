...
(function () {
  ...
  var RU = {
    ...
    photoAlt: 'Медицинский косметолог Виктория в кабинете',
    sub: 'Виктория, медицинский косметолог, принимает в Висагинасе (Sedulinos sveikatos centras). Запишитесь по телефону или напишите SMS.',
    call: 'Позвонить',
    writeSms: 'Написать SMS',
    specCab: 'Кабинет', specReg: 'Запись', specRegV: 'по телефону или SMS', specTel: 'Телефон', specWhere: 'Принимает',
    ...
    p2d: 'Чистка кожи, гидродермабразия лица, процедуры со спикулами, комплексные процедуры омоложения кожи лица, процедуры от пигментации.',
    p3t: 'Аппаратные и лазерные процедуры',
    p3d: 'HIFU, лазерная эпиляция (диодный лазер), удаление капилляров лазером, IPL, лимфодренаж.',
    soon: 'Готовится',
    ...
    desc: 'Медицинский косметолог Виктория принимает в Висагинасе: Sedulinos sveikatos centras, Tarybų g. 6. Запись по телефону +370 612 61703 или по SMS.'
  };
